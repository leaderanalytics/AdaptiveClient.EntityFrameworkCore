...
public static class RegistrationHelperExtensions  
{
    ...
    /// <returns>RegistrationHelper</returns>
    public static RegistrationHelper RegisterDbContextOptions<TOptions>(this RegistrationHelper helper, string providerName) where TOptions: EntityFrameworkCore.IDbContextOptions
    {
        if (string.IsNullOrEmpty(providerName))
            throw new ArgumentNullException("providerName");

        helper.Builder.RegisterType<TOptions>().Keyed<EntityFrameworkCore.IDbContextOptions>(providerName);
        return helper;
    }
